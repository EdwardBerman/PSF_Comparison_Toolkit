...
for file in file_list:
    try:
        ...
        mean_absolute_error_plot_psfex.preprocessing()
        mean_absolute_error_plot_psfex.set_residuals()
        sum_residuals_abs = mean_absolute_error_plot_psfex.return_residuals_sum()
        mean_absolute_error_plot_psfex.set_titles(['Average Star', 'Average PSF', f'Average Absolute Error \n Sum Absolute Error = {sum_residuals_abs}'])
        mean_absolute_error_plot_psfex.save_figure(outname=abs_name)

        mean_chi2_plot_psfex = chi_2_error_plot(ca.catalog(catalog_object_name), ca.epsfex(epsfex_object_name))
        mean_chi2_plot_psfex.preprocessing()
        mean_chi2_plot_psfex.set_residuals()
        sum_residuals_chi2 = mean_chi2_plot_psfex.return_residuals_sum()
        mean_chi2_plot_psfex.set_titles(['Average Star', 'Average PSF', f'Average Chi2 Error \n Sum Chi2 Error = {sum_residuals_chi2}'])
        ...
        sum_residuals_mre = mean_mre_plot_psfex.return_residuals_sum()
        mean_mre_plot_psfex.set_titles(['Average Star', 'Average PSF', f'Average MRE Error \n Sum MRE Error = {sum_residuals_mre}'])
        ...
        sum_residuals_ssim = ssim_plot_psfex.return_residuals_sum()
        ssim_plot_psfex.set_titles(['Average Star', 'Average PSF', f'Average SSIM Error \n Sum SSIM Error = {sum_residuals_ssim}'])
        ssim_plot_psfex.save_figure(outname=ssim_name)
        
        letter_number_codes = re.findall(r'[A-Za-z]\d', file)
        print('\n', 'F'+extract_3_numbers(file)[0]+'W_', letter_number_codes[1], ' Sum Absolute Error = ', sum_residuals_abs, ' Sum Chi2 Error = ', sum_residuals_chi2, ' Sum MRE Error = ', sum_residuals_mre, ' Sum SSIM Error = ', sum_residuals_ssim)
        data_table.add_row(['F'+extract_3_numbers(file)[0]+'W', letter_number_codes[1], sum_residuals_ssim, sum_residuals_chi2, sum_residuals_abs, sum_residuals_mre, sum_residuals_ssim, sum_residuals_chi2, sum_residuals_abs, sum_residuals_mre])
