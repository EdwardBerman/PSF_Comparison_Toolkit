...
mean_absolute_error_plot_psfex.set_titles(['Average Star', 'Average PSF', f'Average Normalized Absolute Error = {sum_residuals_abs_psfex}'])
...
mean_absolute_error_plot_shopt.set_titles([f'Average Star', 'Average PSF', f'Average Normalized Absolute Error = {sum_residuals_abs_shopt}'])
